...
/**
 * Maroon category bar (#7f1d1d), same layout as the philgo original but
 * re-categorized for 88 Hotspring Resort: rooms, promos, cottages, tours,
 * events, dining, guides, policies, community.
